...
\@x{}%
\@y{\@s{0}%
 Abraham \ensuremath{Reines}, 03/20/2021
}%
\@xx{}%
\@x{ {\VARIABLE} hr}%
\@x{ HCini\@s{5.85} \.{\defeq}\@s{4.1} hr \.{\in} ( 1 \.{\dotdot} 12 )}%
 \@x{ HCnxt\@s{4.10} \.{\defeq}\@s{4.09} hr \.{'} \.{=} {\IF} hr \.{\neq} 12
 \.{\THEN} hr \.{+} 1 \.{\ELSE} 1}%
\@x{ HC\@s{4.1} \.{\defeq}\@s{4.1} HCini \.{\land} {\Box} [ HCnxt ]_{ hr}}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM}\@s{4.1} HC \.{\implies} {\Box} HCini}%
\@x{}\bottombar\@xx{}%
\end{document}
